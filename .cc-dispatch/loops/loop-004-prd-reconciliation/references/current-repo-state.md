# Current repo state (as of 2026-06-19 22:40 CDT)

## File tree (infra + dotfiles + docs)
```
docs/prd/PRD-001-student-exercise-infra.md
dotfiles/bootstrap.sh
dotfiles/shell/zshenv
dotfiles/shell/zshrc
infra/cloud-init/template.yaml
...
# Single source of truth. Hostname = the name on each line.
# 14 total = 10 registered + 4 buffer (walk-ins / hot-swap).
# Names chosen for: unambiguous spelling, no negative connotations, Gen 1.
abra
ditto
dragonite
gengar
...
## dotfiles/bootstrap.sh (current, post loop-003)
```bash
#!/usr/bin/env bash
